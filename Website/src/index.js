...
import { downloadAndLoadWorkbook } from "./spreadsheet";
import "bootstrap";
    ...
    $("#regions_div").slideToggle("normal", () => {
      GoogleCharts.api.visualization.events.addListener(
        ...
        e => {
          ...
          winnersSheet.eachRow({ includeEmpty: false }, (row, rowNumber) => {
            ...
            */
            ...
            predictionsWorkbook
              ...
              .eachRow({ includeEmpty: false }, redLightRow => {
            ...
            predictionsWorkbook
              ...
              .eachRow({ includeEmpty: false }, arrivalsRow => {
            ...
            lowData.push({ x: date.getTime(), y: predictionMin });
            actualData.push({ x: date.getTime(), y: actual });
            highData.push({ x: date.getTime(), y: predictionMax });
          });
